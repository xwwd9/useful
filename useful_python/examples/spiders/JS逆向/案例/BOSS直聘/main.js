        ...
        if (start_fun_path) {
            start_fun_path.traverse({
                ExpressionStatement(path) {
                    ...
                    if (t.isStringLiteral(exp.right)) {
                        ...
                        start_fun_path.traverse({
                            MemberExpression(_path) {
                                ...
                                let _parent = _path.parentPath
                                if(t.isAssignmentExpression(_parent.node))
                                    return

                                if(path === _path)
                                    return

                                if (!t.isStringLiteral(node.property) || node.property.value !== property_name)
                                    return
